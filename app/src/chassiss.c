...
{
    POWER_METER_INIT(&POWERS[0],0.1f,0.2f,0.3f,0.4f);
    POWER_METER_INIT(&POWERS[1],0.1f,0.2f,0.3f,0.4f);
    POWER_METER_INIT(&POWERS[2],0.1f,0.2f,0.3f,0.4f);
    POWER_METER_INIT(&POWERS[3],0.1f,0.2f,0.3f,0.4f);
}
